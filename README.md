...
Product Jan Feb Mar Apr May Jun Product A 120 135 150 160 170 180 Product B 80 90 95 100 110 115 Product C 200 210 220 230 240 250 Product D 60 70 75 80 85 90

Converted into NumPy array:

sales_data = np.array([ [120, 135, 150, 160, 170, 180], [80, 90, 95, 100, 110, 115], [200, 210, 220, 230, 240, 250], [60, 70, 75, 80, 85, 90] ]) Dataset 2: Product Prices

Price per unit of each product (in currency units).

Product Price Product A 25 Product B 20 Product C 30 Product D 15 prices = np.array([25, 20, 30, 15]) Dataset 3: Monthly Expenses

Operational expenses per month.

Month Expenses Jan 5000 Feb 5200 Mar 5400 Apr 5600 May 5800 Jun 6000 expenses = np.array([5000, 5200, 5400, 5600, 5800, 6000]) 🔍 Possible Analysis Performed
